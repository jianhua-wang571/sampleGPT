...
SEARCH_TOP_K = os.environ.get("SEARCH_TOP_K", 2)
...
AZURE_SEARCH_VECTOR_COLUMNS = "contentVector"#os.environ.get("AZURE_SEARCH_VECTOR_COLUMNS")
AZURE_SEARCH_QUERY_TYPE = "vectorSemanticHybrid"#os.environ.get("AZURE_SEARCH_QUERY_TYPE")
...
AZURE_OPENAI_TOP_P = os.environ.get("AZURE_OPENAI_TOP_P", 0)
